...
def newGen(cellGroup):
    ...
    for index, cell in enumerate(cellGroup):
        counter = 0
        #check if it's on the edge and NOT corners
        #top edge
        if cell.rect.centery == 11 and cell.rect.centerx != 11 and cell.rect.centerx != 977:
            ...
            if cellGroup[index + 1].living == True:
                counter += 1
        #bottom edge
        elif cell.rect.centery == 578 and cell.rect.centerx != 11 and cell.rect.centerx != 977:
            if cellGroup[index - 1].living == True:
                counter += 1
            if cellGroup[index - 46].living == True:
                counter += 1
            ...
            if cellGroup[index + 1].living == True:
                counter += 1
        #left edge
        elif cell.rect.centerx == 11 and cell.rect.centery != 11 and cell.rect.centery != 578:
            if cellGroup[index - 47].living == True:
                counter += 1
            if cellGroup[index - 46].living == True:
                counter += 1
            ...
            if cellGroup[index + 47].living == True:
                counter += 1
        #right edge
        elif cell.rect.centerx == 977 and cell.rect.centery != 11 and cell.rect.centery != 578:
            if cellGroup[index - 47].living == True:
                counter += 1
            if cellGroup[index - 48].living == True:
                counter += 1
        ...
        #bottom right corner
            ...
            if cellGroup[index - 47].living == True:
                counter += 1
        elif cell.rect.centerx != 11 and cell.rect.centerx != 977 and cell.rect.centery != 11 and cell.rect.centery != 578:
            if cellGroup[index - 48].living == True:
                counter += 1
            if cellGroup[index - 47].living == True:
                counter += 1
